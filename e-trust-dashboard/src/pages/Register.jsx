    ...
    <div className="auth-wrapper">
      <div className="auth-card animate-slide-up" style={{ maxWidth: '480px' }}>
        ...
        <div className="flex-col items-center mb-8">
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem', letterSpacing: '-0.02em' }}>Create Store</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9375rem' }}>Start protecting your business today</p>
        </div>
